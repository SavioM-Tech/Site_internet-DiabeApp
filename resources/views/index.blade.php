...
<body>
        ...
        <div class="th-menu-area text-center">
            ...
            <div class="th-mobile-menu">
                <ul>
                    ...
                    <li><a href="#connaitre">Connaître</a></li>
    ...
    <!-- CONNAITRE -->
    <style>
        .know-sec { padding: 80px 0; background: #f5faf2; }
        .know-intro { max-width: 760px; margin: 0 auto 42px; text-align: center; }
        .know-intro .sub-title { color: #16A34A; font-weight: 700; letter-spacing: .5px; text-transform: uppercase; font-size: 14px; }
        ...
        .know-cta p { color: #334155; font-size: 16px; margin: 0; }
    </style>
    <section class="know-sec" id="connaitre">
        <div class="container">
            ...
            <p class="know-note">Sources : Santé Publique France · Fédération Française des Diabétiques</p>

            <div class="know-cta">
                <p>Envie d'aller plus loin ? Retrouvez articles, conseils et outils de suivi directement dans
                    l'application <strong>Diabe-App</strong>.</p>
            </div>
        </div>
    </section>
