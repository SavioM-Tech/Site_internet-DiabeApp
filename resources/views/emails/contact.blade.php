                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:600px; background-color:#ffffff; border-radius:16px; overflow:hidden; font-family:'Segoe UI', Arial, sans-serif;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#16A34A" style="background-color:#16A34A; background-image:linear-gradient(135deg,#22B573,#16A34A); padding:28px 24px 30px 24px;">
                            <img src="https://diabeapp.com/assets/img/icon-email.png" width="64" height="64" alt="Diabe-App" style="display:block; margin:0 auto 14px auto; width:64px; height:64px; border-radius:16px; border:0;">
